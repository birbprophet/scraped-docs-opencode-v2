---
url: https://opencode.ai/v2/docs/console/models
title: "Models"
...
instead. For a subscription with included usage, see [OpenCode Go](go.md).
...
These AI SDK packages are for applications calling the endpoints directly. To select a [model](../models.md) in OpenCode,
...
You may notice [low-cost models](../models.md), such as Haiku, Nano, or Flash, in your usage history. OpenCode uses these
...
For subscription models, see [Go privacy](go.md#privacy).
