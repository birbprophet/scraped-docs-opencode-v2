...
Use the [Plugins guide](build/plugins.md) to replace V1 hooks and entrypoints. Related local modules and dependencies can
...
Use the `@opencode/client` package to access the released V2 API. See the generated [API reference](api/index.md) for its
