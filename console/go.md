...
If you also have credits on your Console balance, you can enable the **Use balance** option in the console. When enabled, Go will fall back to your [pay-as-you-go balance](models.md#pricing) after you've reached your usage limits instead of blocking requests.
...
the [model](../models.md) using the format `opencode-go/<model-id>`:
