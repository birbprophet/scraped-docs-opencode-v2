...
[OpenCode Go](console/go.md) is an optional subscription for coding models tested by the OpenCode team. Subscribe in the
...
[Provider accounts](cli/providers.md).
